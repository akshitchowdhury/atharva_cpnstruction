...
export default function AboutBranded() {
  return (
    <div className="bg-[#1D2B44]
    md:h-[200px] py-8 sm:py-12 md:py-16 lg:py-6 px-4 sm:px-6 md:px-8 lg:px-32">
      <div className="max-w-7xl mx-auto flex flex-col
      md:flex-col items-center lg:flex-col lg:justify-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
