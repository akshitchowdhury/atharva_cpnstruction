...
const Footer = () => {
  return (
    <footer className="bg-[#E6EBF4] py-8 px-4 md:px-8">
  ...
  />
          ...
          <div className="flex flex-col space-y-2 mb-6 md:mb-0">
            <div className="flex items-center">
              <Home className="w-5 h-5 text-[#FF5757] mr-2" />
              <a href="#" className="text-gray-700 hover:text-[#FF5757]">Home</a>
            </div>
            <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <a href="tel:08068455055" className="text-gray-700 hover:text-[#FF5757]">Gallery</a>
            </div>
            <div className="flex items-center">
              <WorkflowIcon className="w-5 h-5 text-[#FF5757] mr-2" />
              <a href="tel:02235005626" className="text-gray-700 hover:text-[#FF5757]">Career</a>
            </div>
            <div className="flex items-center">
     ...
     <div className="flex flex-col space-y-2 mb-6 md:mb-0">
            <div className="flex items-center md:justify-normal justify-center">
              <MapPin className="w-5 h-5 text-[#FF5757] mr-2" />
              <a href="#" className="text-gray-700 hover:text-[#FF5757]">View on Map</a>
            </div>
            <div className="flex items-center md:justify-normal justify-center">
        ...
        <div className="flex justify-center md:justify-start space-x-4 mb-6">
          ...
          <a href="#" className="text-[#FF0000] hover:text-[#FF5757]">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
            </svg>
          </a>
          <a href="#" className="text-[#E60023] hover:text-[#FF5757]">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
